...
Взять текст из блока вверху, где язык: 
если EN - 
тогда bonus_word = "Bonus"
и кнопка принять участия будет со значением "Take a part",
если RU -
тогда bonus_word = "Бонус"
и кнопка принять участия будет со значением "Принять участие".
...
Добавить парсинг messages,
если блок messages стал messages(1), или messages(2,3,4,5)-
отправь уведомление в тг.

Оформить все это в класс,
опробовать click library.

Создать доп вариант, где бот будет ставить на кэфы <1.15
Автовывод на yoomoney 5$, если balance > 8$
'''
